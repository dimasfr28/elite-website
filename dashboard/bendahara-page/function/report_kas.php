...
$tanggal = date("j F Y");
$mounth = date("F Y");
// $notmounth = mysqli_query($conn, "SELECT *, SUM(saldo) AS saldo_p FROM tb_kas_keluar WHERE NOT date LIKE '%$mounth%'");
// $inmounth = mysqli_query($conn, "SELECT * FROM tb_kas_keluar WHERE date LIKE '%$mounth%'");
