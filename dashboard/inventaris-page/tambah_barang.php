...
include "./function/tambah_barang.php";
		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<div class="container mt-3" style="background-color: #dbdad9;">
				...
				<h5 class="card-title mb-0"> 
					<i class="align-middle" data-feather="edit"></i> Add Items
				</h5>
<hr>
...
<div class="row g-2">
  <h5 class="card-title mb-0" class="form-label" for="barang" style="color: #6d6d6d;">
    ...
    <div class="form-floating">
      <input required type="text" class="form-control" id="barang" name="barang" placeholder="Name Of Items">
...
<div class="row g-2 mt-3">
  ...
  <div class="form-floating">
      <select class="form-select" id="id_kategori" name="id_kategori">
        <?php
			$kuer2 = mysqli_query($conn, "SELECT * FROM tb_kategori_barang"); 
			while ($data3 = mysqli_fetch_array($kuer2)) {
			echo '
				<option value="'.$data3["id_kategori"].'" id="id_kategori" name="id_kategori"'; echo '>'.$data3["nama_kategori"].'</option>';
				}
			?>
      </select>
  ...
  <input required class="form-control form-control-lg" id="foto" name="foto" type="file">
