						...
						<form method="post" enctype="multipart/form-data">
							...
							<div class="row g-2">
								<div class="col-md">
									...
									<div class="form-floating">
										<input maxlength="25" required type="text" class="form-control" id="judul" name="judul" placeholder="Judul Post">
							...
							<div class="row ">
								<div class="col-md">
									...
									<div class="form-floating">
										<input required type="date" class="form-control" id="tgl_post" name="tgl_post" placeholder="tgl_post Post" style="height: 30%;">
								...
								<div class="col-md">
									...
									<input required class="form-control form-control-lg mt-3" id="image_post" name="image_post" type="file">
								</div>
								...
								<div class="mb-3">
									...
									<textarea required name="deskripsi" id="deskripsi" class="form-control" required></textarea>
								</div>
							...
							<div class="col-sm-5 row pb-1" style="margin-left: 29%;">
								<button type="submit" class="btn btn-primary btn-lg" name="post" style="color: white;">Post</button>
							</div>
